...
GMItem["LuaProfiler/client start"] = function(self)
    LuaHookProfiler.start()
end

GMItem["LuaProfiler/client stop"] = function(self)
    LuaHookProfiler.stop()
end

GMItem["LuaProfiler/client dump"] = function(self)

...
GMItem["资源/加方块"] = listResource("block", 10, {Block.GetAirBlockName()}, function(self, tb)
...
---@type LuaHookProfiler
local LuaHookProfiler = T(Lib, "LuaHookProfiler")
GMItem["LuaProfiler/server start"] = function(self)
    LuaHookProfiler.start()
end

GMItem["LuaProfiler/server stop"] = function(self)
    LuaHookProfiler.stop()
end

GMItem["LuaProfiler/server dump"] = function(self)
    LuaHookProfiler.dump()
end

...
function AIEvaluator.ShouldFollowEntity(control)
	...
	if hasEnemy and distanceSqr <= followEntityDistanceWhenHasTarget * followEntityDistanceWhenHasTarget then
		--Lib.logWarning("hasEnemy and distanceSqr <= followEntityDistanceWhenHasTarget * followEntityDistanceWhenHasTarget", distanceSqr, followEntityDistanceWhenHasTarget)
		ret = false
	elseif distanceSqr <= followEntityDistanceWhenNotTarget * followEntityDistanceWhenNotTarget then
		--Lib.logWarning("not hasEnemy and distanceSqr <= followEntityDistanceWhenHasTarget * followEntityDistanceWhenHasTarget", distanceSqr, followEntityDistanceWhenNotTarget)
		ret = false
	end
	return ret
end

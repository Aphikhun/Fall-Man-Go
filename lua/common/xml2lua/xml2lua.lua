...
local XmlParser = require "common.xml2lua.XmlParser"
...
local function anglebrackEtescape(text) --<> 分别转义： Escape
...
local function parseTableKeyToXml(xmltb, tagName, fieldValue, level)
    ...
    if type(fieldValue) == "table" then
        ...
        strValue = anglebrackEtescape(strValue)
    end

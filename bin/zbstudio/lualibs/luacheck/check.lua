local check_state = ZBREQUIRE "luacheck.check_state"
local core_utils = ZBREQUIRE "luacheck.core_utils"
local parse_inline_options = ZBREQUIRE "luacheck.stages.parse_inline_options"
local parser = ZBREQUIRE "luacheck.parser"
local stages = ZBREQUIRE "luacheck.stages"

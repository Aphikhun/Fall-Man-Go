...
local urllib = ZBREQUIRE 'socket.url'
...
local assert, error, getmetatable, io, os, pairs, print, ZBREQUIRE, string, tonumber =
	assert, error, getmetatable, io, os, pairs, print, ZBREQUIRE, string, tonumber

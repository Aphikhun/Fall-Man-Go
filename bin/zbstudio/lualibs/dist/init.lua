...
local cfg = ZBREQUIRE "dist.config"
local depends = ZBREQUIRE "dist.depends"
local git = ZBREQUIRE "dist.git"
local sys = ZBREQUIRE "dist.sys"
local package = ZBREQUIRE "dist.package"
local mf = ZBREQUIRE "dist.manifest"
local utils = ZBREQUIRE "dist.utils"

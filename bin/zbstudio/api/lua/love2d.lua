 ...
 childs = {
  ...
  filesystem = {
   childs = {
    ...
    getCRequirePath = {
     args = "()",
     description = "Gets the filesystem paths that will be searched for c libraries when ZBREQUIRE is called.\n\nThe paths string returned by this function is a sequence of path templates separated by semicolons. The argument passed to ZBREQUIRE will be inserted in place of any question mark (\"?\") character in each template (after the dot characters in the argument passed to ZBREQUIRE are replaced by directory separators.) Additionally, any occurrence of a double question mark (\"??\") will be replaced by the name passed to ZBREQUIRE and the default library extension for the platform.\n\nThe paths are relative to the game's source and save directories, as well as any paths mounted with love.filesystem.mount.",
    ...
    getRequirePath = {
     args = "()",
     description = "Gets the filesystem paths that will be searched when ZBREQUIRE is called.\n\nThe paths string returned by this function is a sequence of path templates separated by semicolons. The argument passed to ZBREQUIRE will be inserted in place of any question mark (\"?\") character in each template (after the dot characters in the argument passed to ZBREQUIRE are replaced by directory separators.)\n\nThe paths are relative to the game's source and save directories, as well as any paths mounted with love.filesystem.mount.",
     returns = "(paths: string)",
     type = "function"
    },
    getSaveDirectory = {
    ...
    setCRequirePath = {
     args = "(paths: string)",
     description = "Sets the filesystem paths that will be searched for c libraries when ZBREQUIRE is called.\n\nThe paths string returned by this function is a sequence of path templates separated by semicolons. The argument passed to ZBREQUIRE will be inserted in place of any question mark (\"?\") character in each template (after the dot characters in the argument passed to ZBREQUIRE are replaced by directory separators.) Additionally, any occurrence of a double question mark (\"??\") will be replaced by the name passed to ZBREQUIRE and the default library extension for the platform.\n\nThe paths are relative to the game's source and save directories, as well as any paths mounted with love.filesystem.mount.",
     returns = "()",
     type = "function"
    },
    setIdentity = {
    ...
    setRequirePath = {
     args = "(paths: string)",
     description = "Sets the filesystem paths that will be searched when ZBREQUIRE is called.\n\nThe paths string given to this function is a sequence of path templates separated by semicolons. The argument passed to ZBREQUIRE will be inserted in place of any question mark (\"?\") character in each template (after the dot characters in the argument passed to ZBREQUIRE are replaced by directory separators.)\n\nThe paths are relative to the game's source and save directories, as well as any paths mounted with love.filesystem.mount.",
     returns = "()",
     type = "function"
    },
    setSource = {
...
print((ZBREQUIRE 'mobdebug').line(convert(love), {indent = ' ', comment = false}))

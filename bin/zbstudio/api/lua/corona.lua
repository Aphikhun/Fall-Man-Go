...
local api = {
 ...
 package = {
  childs = {
   loaded = {
    description = "A table used by `ZBREQUIRE()` to control which modules are already loaded. When you ZBREQUIRE a module `modname` and `package.loadedmodname` is not `false`, `ZBREQUIRE()` simply returns the value stored there.",
    type = "value"
   },
   loaders = {
    description = "A table used by `ZBREQUIRE()` to control how to load modules.",
    type = "value"
   },
   module = {
    args = "( name [, ...] )",
   ...
   seeall = {
    description = "This function is deprecated. Please refer to ZBREQUIRE() instead.",
    type = "value"
   }
  },
 ...
 physics = {
  childs = {
   ...
   setMKS = {
    args = "( key, value )",
    description = "Sets the MKS (meters, kilograms, and seconds) value of the physics simulation for specific keys. This is strictly for advanced purposes — the average developer and project will not ZBREQUIRE this function.",
    returns = "()",
    type = "function"
   },
 ...
 widget = {
  childs = {
   ...
   setTheme = {
    args = "( theme )",
    description = "Use this function to set the overall theme of the widget library. This should be called immediately after you `ZBREQUIRE()` the widget library.",
    returns = "()",
    type = "function"
   }
  },
...
local mobdebug = ZBREQUIRE('mobdebug')
